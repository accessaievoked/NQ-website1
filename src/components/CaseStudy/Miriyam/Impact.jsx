...
import feature1Front from "../../../assets/images/Casestudy/Miriyam/impact1.png";
import feature1DecoyLeft from "../../../assets/images/Casestudy/Miriyam/impact2.png";
import feature1DecoyRight from "../../../assets/images/Casestudy/Miriyam/impact3.png";

import feature2Front from "../../../assets/images/Casestudy/Miriyam/impact2.png";
import feature2DecoyLeft from "../../../assets/images/Casestudy/Miriyam/impact3.png";
import feature2DecoyRight from "../../../assets/images/Casestudy/Miriyam/impact1.png";

import feature3Front from "../../../assets/images/Casestudy/Miriyam/impact3.png";
import feature3DecoyLeft from "../../../assets/images/Casestudy/Masculino/impact1.png";
import feature3DecoyRight from "../../../assets/images/Casestudy/Masculino/impact2.png";

const features = [
  {
    calloutLabel: "Product Bundle",
    ...
    optimizations: [
      {
        heading: "Opportunity :",
        subheading:
          "Customers had no incentive to purchase complementary products.",
      },
      {
        heading: "Solution :",
        subheading:
          "Introduced product bundles to encourage multi-item purchases.",
      },
      {
        heading: "Impact :",
  ...
  {
    calloutLabel: "Estimate Delivery",
    ...
    optimizations: [
      {
        heading: "Opportunity :",
        subheading:
          "Customers lacked clarity on when their order would arrive.",
      },
      {
        heading: "Solution :",
        subheading:
          "Displayed estimated delivery dates for Kerala and other states.",
      },
      {
        heading: "Impact :",
        subheading: "↑ Purchase Confidence\n ↑ Checkout Completion",
      },
    ],
  },
  {
    calloutLabel: "Product Offers",
    ...
    optimizations: [
      {
        heading: "Opportunity :",
        subheading:
          "Promotional offers were difficult to discover during the buying journey.",
      },
      {
        heading: "Solution :",
        subheading:
          "Highlighted offers across the PDP and Buy Now CTA.",
      },
      {
        heading: "Impact :",
        subheading: "↑ Offer Redemption\n ↑ Conversion Rate",
      },
    ],
  },
];
      ...
      <div className="w-full">
        ...
        <div className="max-w-[540px] mx-auto md:mx-12 text-center md:text-left">
          ...
          <p className="text-[10px] md:text-[15px]  text-gray-600">
           Through UX analysis and customer behavior insights, we identified key gaps across the product and cart journey. The following optimizations were introduced to improve product discovery, increase promotional visibility, build customer trust, and encourage higher-value purchases.
            </p>
        </div>
      </div>
    </section>
