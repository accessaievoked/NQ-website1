...
const stats = [
  {
    id: 1,
    body: "Custom Currency Converter with Automatic Location-Based Detection \ n Automated Customer Email Workflows using Tags & Trigger-Based Automation",
    label: "Deliverables",
  ...
  {
    id: 2,
    body: "A more localized shopping experience for international customers and a scalable customer communication system ready for future marketing campaigns.",
    label: "Results",
